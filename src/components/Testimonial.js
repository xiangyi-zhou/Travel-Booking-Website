          ...
          >
            <div className="cardss">
              ...
              <p className="dummy mt-3 ">
                Yichang's natural beauty left me speechless. The stunning
                landscapes and rich cultural heritage were truly unforgettable.
              </p>
            ...
            <div className="cardss">
              ...
              <ImQuotesRight className="quata" />
              <p className="dummy mt-3 ">
                The luxury accommodations in Yichang were beyond my
                expectations. From the comfortable rooms to the world-class
                amenities, every detail was perfect.
              </p>
            ...
            <div className="cardss">
              ...
              <ImQuotesRight className="quata" />
              <p className="dummy mt-3 ">
                Yichang's expert guides helped me discover hidden gems and learn
                about the city's rich history and culture. I couldn't have asked
